...
const AdminContextProvider = (props) => {
    ...
    // sanitize env value to avoid surrounding quotes or comments
    ...
    const removeDoctor = async (docId) => {
        try {
            ...
            const { data } = await axios.post(backendUrl + '/api/admin/delete-doctor', { doctorId: docId }, { headers: { aToken } })
            if (data.success) {
                toast.success(data.message)
                getAllDoctors()
            } else {
